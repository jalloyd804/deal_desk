...
export const Sidebar = ({
    ...
    const handleSubmit = async () => {
        ...
        if (file) {
            if (!textFieldValue) {
                setTextFieldError('Text field is required to add a document.');
                setLoading(false);
                setIsLoading(false);
                return;
            }
            ...
            try {
                ...
                const pixel = `CreateEmbeddingsFromDocuments( engine = "${embedEngine.database_id}" , filePaths = ["${fileInfo.fileLocation}"]) ;`;
